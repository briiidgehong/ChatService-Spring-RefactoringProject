...
<body>
    ...
    <section class="more__plus-friends">
      ...
      <div class="plus-friends__items">
        <div class="plus-friends__item">
          ...
          <span class="plus_friens__item-title">Order</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-home"></i>
          <span class="plus_friens__item-title">Store</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-television"></i>
          <span class="plus_friens__item-title">TV Channel/Radio</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-pencil"></i>
          <span class="plus_friens__item-title">Creation</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-graduation-cap"></i>
          <span class="plus_friens__item-title">Education</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-university"></i>
          <span class="plus_friens__item-title">Politics/Society</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-krw"></i>
          <span class="plus_friens__item-title">Finance</span>
        </div>
        <div class="plus-friends__item">
          <i class="fa fa-video-camera"></i>
          <span class="plus_friens__item-title">Movie/Music</span>
        </div>
      </div>
    </section>
  ...
  <nav class="tab-bar">
    ...
    <a href="more.jsp" class="tab-bar__tab  tab-bar__tab--selected">
